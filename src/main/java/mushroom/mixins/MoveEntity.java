...
import mushroom.Features.Macros.Eagle;
...
public abstract class MoveEntity {
    ...
    public void moveEntity(double p_moveEntity_1_, double p_moveEntity_3_, double p_moveEntity_5_) {
        final MoveEvent event = new MoveEvent(p_moveEntity_1_, p_moveEntity_3_, p_moveEntity_5_);
        ...
        if (this.noClip) {
            ...
            if ((Configs.eagle && Configs.eaglemode != 0) || (Configs.scaffold && Configs.safewalkScaffold)) {
                flag = (PlayerLib.inGame() && PlayerLib.isOverAir() && Eagle.eagletriggered() && (mc.thePlayer.onGround || !Configs.groundonly)) || this.isSneaking() || (Configs.scaffold && (Configs.safewalkScaffold && (mc.thePlayer.onGround || Configs.airSafewalkScaffold)));
            }
